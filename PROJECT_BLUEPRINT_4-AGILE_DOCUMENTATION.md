...
**Duration:** 2 Months (Oct 13 - Dec 12, 4 Sprints)  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| Sprint 1 | Sprint 1 | US-00 | As a team, we need to **learn Python & Data Science libraries** (Pandas, Numpy) to build the tool. | Must Have | None | All Team | Done |
| Sprint 2 | Sprint 2 | US-01 | As a lead, I want to **initialize the project structure** and repo so the team can collaborate. | Must Have | None | Sami (Lead) | Done |
| Sprint 2 | Sprint 2 | US-02 | As a user, I want a **Data Upload Page** to load traffic CSVs. | Must Have | US-01 | Divija | Done |
| Sprint 2 | Sprint 2 | US-03 | As a system, I need **robust git conflict handling** to merge 13 members' code. | Must Have | None | Anshu | Done |
| Sprint 3 | Sprint 3 | US-04 | As a user, I want distinct **Visualization Pages** for different insights. | Must Have | US-02 | Ishwari | Done |
| Sprint 3 | Sprint 3 | US-05 | As a user, I want **Visual Plots** (Bar/Pie) for traffic trends. | Must Have | US-04 | Harika | Done |
| Sprint 4 | Sprint 4 | US-06 | As a brand, I want a custom **Logo and Platform Identity (Collision X)**. | Should Have | None | Mrunalini | Done |
| Sprint 4 | Sprint 4 | US-07 | As a user, I want a **Map Visualization** using specific GeoJSONs for accurate regions. | Must Have | US-02 | Amith | Done |

---

## 2. 🏃 Sprint Backlog (Sprint 2: Foundation & Kickoff)

**Sprint 2 Goal (Oct 27 - Nov 09):** Transition from learning to building. Initialize "Collision X", handle first uploads, and resolve Git chaos.
...
| :--- | :--- | :--- | :--- | :--- |
| **Sp 2** | Day 3 | Nov 03 | **Blocker:** Anshu reported massive merge conflicts due to 13 people pushing to `main`. | **Action:** Sami enforced "Pull Rebase" policy; Anshu took ownership of all complex merges. |
...
| **Sp 4** | Day 2 | Dec 02 | **Blocker:** Map plotting failing. Standard maps don't match our data regions. | **Action:** Amith spent 2 days finding the correct Open Source **GeoJSON** files from the internet. |
| **Sp 4** | Day 4 | Dec 04 | **Task:** Need a unique identity. | **Action:** Mrunalini designed the **"Collision X"** logo and theme assets. |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | Sprint 2 | Anshu | Review large PRs in pairs. | Trying to merge everything on Friday evening. | effectively communicating conflict resolutions. |
| 2 | Sprint 3 | Sami | Leveraging **Gemini/Claude** for tricky Pandas debugging. | Writing custom CSS without checking Streamlit support. | guiding the team on architecture. |
| 3 | Sprint 3 | Mrunalini | Creating assets (Logo) earlier in the sprint. | Using hardcoded paths. | improving UI aesthetics. |
| 4 | Sprint 4 | Amith | Validating GeoJSON files before implementation. | Ignoring projection errors. | searching for open-source resources. |
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| BUG-01 | **Map Visibility:** Map not loading for certain States. | Sprint 4 | Amith | Data | Swapped broken GeoJSON with valid Open Source files found online. | Closed |
| BUG-02 | **Merge Conflict:** `app.py` overwritten by accident. | Sprint 2 | Anshu | Process | Reverted commit; established strict merge order. | Closed |
